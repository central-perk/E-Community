...
exports.showEdit = function (req, res, next) {
	...
	Reply.getReplyById(reply_id, function (err, reply) {
		...
		if (req.user._id.toString() === reply.author_id.toString() || req.user.is_admin) {
...
exports.update = function (req, res, next) {
	...
	Reply.getReplyById(reply_id, function (err, reply) {
		...
		if (String(reply.author_id) === req.user._id.toString() || req.user.is_admin) {
