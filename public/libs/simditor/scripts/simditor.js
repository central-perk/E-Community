(function (root, factory) {
  ...
  Selection = (function (_super) {
    ...
    Selection.prototype.rangeAtEndOf = function (node, range) {
      ...
      if (
        !(
          range.endOffset === endNodeLength - 1 &&
          $(endNode).contents().last().is("br")
        ) &&
        range.endOffset !== endNodeLength
      ) {
        return false;
      }
      if (node === endNode) {
          ...
          (function (_this) {
            return function (i, n) {
              ...
              if (
                !(
                  $lastChild.get(0) === n ||
                  ($lastChild.is("br") && $lastChild.prev().get(0) === n)
                )
              ) {
                result = false;
                return false;
    ...
    Selection.prototype.deleteRangeContents = function (range) {
      ...
      if (
        !range.collapsed &&
        this.rangeAtStartOf(this.editor.body, startRange) &&
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            if (
              !(
                allowedAttributes != null &&
                ((_ref1 = attr.name),
                __indexOf.call(allowedAttributes, _ref1) >= 0)
              )
            ) {
      ...
      return $contents.each(
        (function (_this) {
          return function (i, el) {
            ...
            $el = $(el);
            if (
              $el.is(':not(img, br, col, td, hr, [class^="simditor-"]):empty')
            ) {
              $el.remove();
            }
            if (uselessP($el)) {
  ...
  InputManager = (function (_super) {
    ...
    InputManager.prototype._init = function () {
      var submitKey;
      this.editor = this._module;
      this.throttledTrigger = this.editor.util.throttle(
        (function (_this) {
          return function () {
            var args;
      ...
      this.editor.body
        ...
        .on("paste", $.proxy(this._onPaste, this))
      ...
      if (this.editor.util.browser.firefox) {
        this.addShortcut(
          ...
          (function (_this) {
            return function (e) {
              e.preventDefault();
              _this.editor.selection.sel.modify(
                "move",
                "backward",
                "lineboundary"
              );
    ...
    InputManager.prototype._onBlur = function (e) {
      ...
      this.lastCaretPosition =
        (_ref = this.editor.undoManager.currentState()) != null
          ? _ref.caret
          : void 0;
    ...
    InputManager.prototype._onKeyDown = function (e) {
      ...
      if (e.which in this._keystrokeHandlers) {
        result =
          typeof (_base = this._keystrokeHandlers[e.which])["*"] === "function"
            ? _base["*"](e)
            : void 0;
        if (result) {
        ...
        this.editor.util.traverseUp(
          (function (_this) {
            return function (node) {
              ...
              handler =
                (_ref = _this._keystrokeHandlers[e.which]) != null
                  ? _ref[node.tagName.toLowerCase()]
                  : void 0;
              result =
      ...
      if (
        ((_ref = e.which), __indexOf.call(this._modifierKeys, _ref) >= 0) ||
      ...
      return setTimeout(
        (function (_this) {
          return function () {
            ...
            if (
              _this.editor.triggerHandler("pasting", [pasteContent]) === false
            ) {
              return;
            }
            if (!pasteContent) {
  ...
  Keystroke = (function (_super) {
    ...
    Keystroke.prototype._init = function () {
      ...
      if (this.editor.util.browser.safari) {
        this.editor.inputManager.addKeystrokeHandler(
          "13",
          "*",
          (function (_this) {
            return function (e) {
      ...
      this.editor.inputManager.addKeystrokeHandler(
        ...
        (function (_this) {
          return function (e) {
            ...
            $blockEl = _this.editor.util.closestBlockEl();
            if (
              _this.editor.util.browser.webkit &&
              _this.editor.selection.rangeAtStartOf($blockEl)
            ) {
              _this.editor.selection.save();
      ...
      this.editor.inputManager.addKeystrokeHandler(
        ...
        (function (_this) {
          return function (e) {
            ...
            if (
              !(
                _this.editor.opts.tabIndent ||
                (codeButton && codeButton.active)
              )
            ) {
              return;
            }
          ...
          return function (e, $node) {
            ...
            if (
              !(
                ...
                $node.is(_this.editor.util.closestBlockEl())
              )
            ) {
              return;
            }
        ...
        (function (_this) {
          return function (e, $node) {
            ...
            if (
              $textNode &&
              text.length === 1 &&
              _this.editor.util.browser.firefox &&
              !$textNode.next("br").length
            ) {
      ...
      this.editor.inputManager.addKeystrokeHandler(
        ...
        (function (_this) {
          return function (e, $node) {
            ...
            $newNode = $("<p/>")
              .append(codeStr || _this.editor.util.phBr)
              .insertAfter($node);
            $node.remove();
            range = document.createRange();
      ...
      return this.editor.inputManager.addKeystrokeHandler(
        "8",
        "blockquote",
        (function (_this) {
          return function (e, $node) {
  ...
  UndoManager = (function (_super) {
    ...
    UndoManager.prototype._init = function () {
      ...
      this.editor.inputManager.addShortcut(
        undoShortcut,
        (function (_this) {
          return function (e) {
            e.preventDefault();
    ...
    UndoManager.prototype.caretPosition = function (caret) {
      ...
      if (!caret) {
        ...
        caret.start = this._getNodePosition(
          range.startContainer,
          range.startOffset
        );
        if (!range.collapsed) {
          caret.end = this._getNodePosition(
            range.endContainer,
            range.endOffset
          );
    ...
    Util.prototype.browser = (function () {
      ...
      if (ie) {
        return {
          msie: true,
          version:
            ((_ref = ua.match(/(msie |rv:)(\d+(\.\d+)?)/i)) != null
              ? _ref[2]
              : void 0) * 1,
        };
      } else if (chrome) {
        return {
          ...
          chrome: true,
          version:
            ((_ref1 = ua.match(/(?:chrome|crios)\/(\d+(\.\d+)?)/i)) != null
              ? _ref1[1]
              : void 0) * 1,
        };
      } else if (safari) {
        return {
          ...
          safari: true,
          version:
            ((_ref2 = ua.match(/version\/(\d+(\.\d+)?)/i)) != null
              ? _ref2[1]
              : void 0) * 1,
        };
      } else if (firefox) {
        return {
          ...
          firefox: true,
          version:
            ((_ref3 = ua.match(/firefox\/(\d+(\.\d+)?)/i)) != null
              ? _ref3[1]
              : void 0) * 1,
        };
      } else {
  ...
  Toolbar = (function (_super) {
    ...
    Toolbar.prototype._init = function () {
      ...
      if (!this.opts.toolbarHidden && this.opts.toolbarFloat) {
        ...
        if (!this.editor.util.os.mobile) {
          $(window)
            .on(
              "resize.simditor-" + this.editor.id,
              (function (_this) {
                return function (e) {
    ...
    Toolbar.prototype.toolbarStatus = function (name) {
      ...
      return this.editor.util.traverseUp(
        (function (_this) {
          return function (node) {
  ...
  Simditor = (function (_super) {
    ...
    Simditor.prototype.opts = {
      textarea: null,
      placeholder: "",
      defaultImage: "http://s.echuandan.com/images/logo/default/xuan.png",
      params: {},
      upload: false,
      tabIndent: true,
    };
    ...
    Simditor.prototype._placeholder = function () {
      ...
      if (
        ...
        (children.length === 1 &&
          ...
          ((_ref = children.data("indent")) != null ? _ref : 0) < 1)
      ) {
  ...
  Simditor.i18n = {
    "zh-CN": {
      ...
      insertColumnLeft: "Insert column on the left",
      insertColumnRight: "Insert column on the right",
  ...
  Button = (function (_super) {
      ...
      this.el.on(
        ...
        (function (_this) {
          return function (e) {
            ...
            e.preventDefault();
            if (
              _this.el.hasClass("disabled") ||
              (_this.needFocus && !_this.editor.inputManager.focused)
            ) {
              return false;
            }
            if (_this.menu) {
    ...
    Button.prototype.render = function () {
      ...
      this.el
        .find("span")
        .addClass(this.icon ? "fa fa-" + this.icon : "")
        .text(this.text);
      if (!this.menu) {
        return;
      }
  ...
  Popover = (function (_super) {
    ...
    Popover.prototype.show = function ($target, position) {
      ...
      this.el.siblings(".simditor-popover").each(
        (function (_this) {
          return function (i, popover) {
            popover = $(popover).data("popover");
            if (popover.active) {
    ...
    Popover.prototype.refresh = function (position) {
      ...
      left = Math.min(
        targetOffset.left - editorOffset.left,
        ...
        (function (_this) {
          return function (i, el) {
            ...
            for (_i = 0, _len = converted.length; _i < _len; _i++) {
              ...
              if (
                results.length &&
                results[results.length - 1].is(_this.type) &&
                c.is(_this.type)
              ) {
        ...
        (function (_this) {
          return function (i, el) {
            ...
            for (_i = 0, _len = converted.length; _i < _len; _i++) {
              ...
              if (
                results.length &&
                results[results.length - 1].is(_this.htmlTag) &&
                c.is(_this.htmlTag)
              ) {
                _results.push(results[results.length - 1].append(c.children()));
              } else {
  ...
  ImagePopover = (function (_super) {
    ...
    ImagePopover.prototype._restoreImg = function () {
      var size, _ref;
      size = ((_ref = this.target.data("image-size")) != null
        ? _ref.split(",")
  ...
  TableButton = (function (_super) {
      ...
      $wrapper.on(
        ...
        (function (_this) {
          return function (e) {
            ...
            if (
              (_ref = $resizeHandle.data("td")) != null ? _ref.is($td) : void 0
            ) {
              $resizeHandle.show();
              return;
            }
            ...
            if (
              (_ref1 = $resizeHandle.data("col")) != null
                ? _ref1.is($col)
                : void 0
            ) {
              $resizeHandle.show();
    ...
    TableButton.prototype._initShortcuts = function () {
      ...
      return this.editor.inputManager.addShortcut(
        "ctrl+alt+right",
        (function (_this) {
          return function (e) {
            _this.editMenu
    ...
    TableButton.prototype.refreshTableWidth = function ($table) {
      ...
      cols = $table.find("col");
      return $table.find("tr:first td").each(
        (function (_this) {
          return function (i, td) {
            var $col;
            $col = cols.eq(i);
