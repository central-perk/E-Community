(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor-mention', ["jquery",
      "simditor",
      "simple-module"], function ($, Simditor, SimpleModule) {
      return (root.returnExportsGlobal = factory($, Simditor, SimpleModule));
    });
    ...
    root['SimditorMention'] = factory(jQuery,
      Simditor,
      SimpleModule);
  }
...
SimditorMention = (function(_super) {
  __extends(SimditorMention, _super);
